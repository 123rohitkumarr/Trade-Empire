    ...
    <div className="container">
      ...
      <div className="card">
        <h2 className="heading">
          <span className="text">Welcome Back, Trader</span>{' '}
          <span className="emoji">💸</span>
        </h2>
        <p className="subtext">Login to your TradeEmpire account</p>
        ...
        <p className="link" onClick={() => navigate('/register')}>
          Don't have an account? <span className="link-highlight">Register here</span>
        </p>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .link-highlight { color: #818cf8; font-weight: 600; }
